...
export default function AgreementsPage() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-extrabold text-slate-900">Smart Agreements</h1>
        <p className="text-slate-600">Auto-executing digital contracts with blockchain proof</p>
      </div>
